...
def main():
    ...
    header.write(navbar_contents, unsafe_allow_html=True)
...
#------------------------------Navbar config ends------------------------------
    ...
    header[data-testid="stHeader"] {#NavBar
        position: sticky;
        top: 15px;
        left: 95vw;
        height: 3rem;
        width:4rem;
        background: rgb(197 35 25);
        # outline: none;
        z-index: 2;
        display: block;
        color: white;
    ...
    # .e1ewe7hr3{#hamburger color
    # color: white;
    # }
    
    .css-fq7fy2 {#stop color
    color: white;
    }
...
#------------------------------CSS alteration ends------------------------------
    ...
    if input_files:
        ...
        if process_button and output_dir:
            ...
            # Remove the existing output directory if it exists (use if required)
           ...
           # Create the output directory
            ...
            redacted_files, success_count = redact_documents(file_list, output_dir)
